            ...
            <div className="flex w-full flex-row space-x-4">
              ...
              >
                <Tabs.List className="relative z-10 flex flex-row">
                  ...
                  <Tabs.Trigger
                    value="settings"
                    className="w-12 cursor-pointer rounded-sm rounded-b-none border border-b-0 border-white/5 px-4 py-2 text-left transition duration-300 ease-linear hover:text-white rdx-state-active:bg-[#313135] rdx-state-active:text-white rdx-state-inactive:text-white/50"
                  >
                    <BiCog className="" />
                  </Tabs.Trigger>
                </Tabs.List>
