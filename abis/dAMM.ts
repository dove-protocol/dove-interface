export const dAMM = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "remote", type: "address" },
      { internalType: "address", name: "local", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint16", name: "_destChainId", type: "uint16" },
      { internalType: "address", name: "_amm", type: "address" },
    ],
    name: "syncL2",
    outputs: [],
