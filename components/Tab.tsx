...
const Tab = ({
  ...
  return (
    <Tabs.Trigger
      value={id}
      className="relative flex cursor-pointer flex-row items-center justify-center rounded-sm border border-transparent w-full px-4 py-1 transition duration-300 ease-linear hover:text-white focus:outline-none rdx-state-active:border-white/5 rdx-state-active:bg-black/10 rdx-state-active:text-white rdx-state-inactive:text-white/50"
