...
export const Button = ({
  ...
  return (
    <button
      disabled={disabled}
      onClick={onClick}
      className="group flex h-16 w-full items-center justify-center rounded-sm border-y border-sky-400/50 bg-sky-400/5 shadow-damn transition duration-500 ease-in-out hover:shadow-none disabled:border-none disabled:bg-white/5 disabled:shadow-none"
    >
      <p
